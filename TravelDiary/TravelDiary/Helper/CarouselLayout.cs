...
namespace TravelDiary.Helper
{
    ...
    {
      public static  CarouselLayout CreatePagesCarousel()
        {
            var carousel = new CarouselLayout
            {
                HorizontalOptions = LayoutOptions.FillAndExpand,
                VerticalOptions = LayoutOptions.FillAndExpand,
                IndicatorStyle = IndicatorStyleEnum.Dots,
        ...
        public static View CreatePagerIndicatorContainer()
        {
        ...
        public static View CreatePagerIndicators()
        {
